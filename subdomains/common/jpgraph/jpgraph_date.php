...
// Ver:		$Id: jpgraph_date.php,v 1.3 2005/05/05 22:24:24 aditus Exp $
//
// License:	This code is released under QPL
// Copyright (C) 2005 Johan Persson
//========================================================================
*/
...
DEFINE('MINSECADJ_1',0);
DEFINE('MINSECADJ_5',1);
DEFINE('MINSECADJ_10',2);
DEFINE('MINSECADJ_15',3);
DEFINE('MINSECADJ_30',4);
...
//------------------------------------------------------------------------------------------
	...
	$scalePoints = 
		...
		/* SECPERDAY*7,array(SECPERDAY*7,array(SECPERDAY),      DAYADJ_WEEK, ''), */
		...
		SECPERDAY*7,array(array(SECPERDAY,SECPERHOUR*12,SECPERHOUR*6,SECPERHOUR*2),array(SECPERHOUR*6,SECPERHOUR*3,SECPERHOUR,SECPERHOUR),
				  array(0,DAYADJ_1, 1,30+HOURADJ_12, 1,30+HOURADJ_6, 1,30+HOURADJ_1)),
		...
		SECPERDAY,array(array(SECPERDAY,SECPERHOUR*12,SECPERHOUR*6,SECPERHOUR*2,SECPERHOUR),array(SECPERHOUR*6,SECPERHOUR*2,SECPERHOUR,SECPERHOUR,SECPERHOUR),
				array(1,30+HOURADJ_12, 1,30+HOURADJ_6, 1,30+HOURADJ_1, 1,30+HOURADJ_1)),
		...
		SECPERHOUR*12,array(array(SECPERHOUR*2,SECPERHOUR,SECPERMIN*30,900,600),array(1800,1800,900,300,300),
				    array(1,30+HOURADJ_1, 1,20+MINSECADJ_30, 1,20+MINSECADJ_15, 1,20+MINSECADJ_10, 1,20+MINSECADJ_5) ),
		...
		SECPERHOUR,array(array(SECPERMIN*30,900,600,300),array(900,300,120,60),
				 array(1,20+MINSECADJ_30, 1,20+MINSECADJ_15, 1,20+MINSECADJ_10, 1,20+MINSECADJ_5) ),

		/* Intervall larger than 30 min */
		SECPERMIN*30,array(array(SECPERMIN*15,SECPERMIN*10,SECPERMIN*5,SECPERMIN),array(300,300,60,10),
				   array(1,20+MINSECADJ_15, 1,20+MINSECADJ_10, 1,20+MINSECADJ_5, 1,20+MINSECADJ_1)),

		/* Intervall larger than 1 min */
		SECPERMIN,array(array(SECPERMIN,15,10,5),array(15,5,2,1),
				array(1,20+MINSECADJ_1, 1,MINSECADJ_15, 1,MINSECADJ_10, 1,MINSECADJ_5)),

		/* Intervall larger than 10 sec */
		10,array(array(5,2),array(1,1),array(1,MINSECADJ_5, 1,MINSECADJ_1)),

		/* Intervall larger than 1 sec */
		1,array(array(1),array(1),array(1,MINSECADJ_1)),
		);
	...
	//$factors = array(150,90,40,20,10);
	//$widthFactor = $factors[$aDens%5];
	//$numsteps = floor($img->plotwidth/$widthFactor);
	$done=false;
	$i=0;
	while( ! $done && $i < 5) {
	...
	*/
	...
	if( $this->iEndAlign !== false ) {
	    $adjend   = $this->AdjEndDate($aEndTime,$this->iEndAlign);
	}
