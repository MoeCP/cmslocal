...
class QuickBooks_API
{
	...
	*/
    ...
    // added by nancy xu 2011-06-10 22:27
	public function cSaveVendor($obj, $callback = null, $webapp_ID = null, $priority = null)
	{
		$err = '';
		return $this->_doMod(__METHOD__, QUICKBOOKS_MOD_VENDOR, QUICKBOOKS_OBJECT_VENDOR, $obj, $callback, $webapp_ID, $priority, $err);
	}
	public function cAddCheck($obj, $callback = null, $webapp_ID = null, $priority = null)
	{
		$err = '';
		return $this->_doAdd(__METHOD__, QUICKBOOKS_ADD_CHECK, QUICKBOOKS_OBJECT_CHECK, $obj, $callback, $webapp_ID, $priority, $err);
	}
	public function cAddBill($obj, $callback = null, $webapp_ID = null, $priority = null)
	{
		$err = '';
