 ...
 *
 */
require_once 'QuickBooks/Object/Bill/ExpenseLine.php';

/**
 *
 */
require_once 'QuickBooks/Object/Bill/ItemLine.php';

/**
 *
 */
require_once 'QuickBooks/Object/Bill/ItemGroupLine.php';
...
{
	/**
	 * Create a new QuickBooks_Object_Bill object
	 * 
	 * @param array $arr
	 */
	...
	/**
	 * Set the PayeeEntityRef ListID for the Bill
	 * 
	 * @param string $ListID		The ListID of the record to reference
	 * @return boolean
	 */
	...
	/**
	 * Get the PayeeEntityRef ListID for the Bill
	 * 
	 * @return string
	 */
	...
	/**
	 * Set the PayeeEntityRef FullName for the Bill
	 * 
	 * @param string $FullName		The FullName of the record to reference
	 * @return boolean
	 */
	...
	/**
	 * Get the PayeeEntityRef FullName for the Bill
	 * 
	 * @return string
	 */
	...
	/**
	 * Set the IsToBePrinted for the Bill
	 * 
	 * @param boolean $bool
	 * @return boolean
	 */
	...
	/**
	 * Get the IsToBePrinted for the Bill
	 * 
	 * @return boolean
	 */
	...
	/**
	 * Set the IsTaxIncluded for the Bill
	 * 
	 * @param boolean $bool
	 * @return boolean
	 */
	...
	/**
	 * Get the IsTaxIncluded for the Bill
	 * 
	 * @return boolean
	 */
	...
	public function addAddBillToTxn($obj)
	{
		return $this->addListItem('AddBillToTxn', $obj);
	}
	...
	public function asList($request)
	{
		switch ($request)
		{
			case 'BillAddRq':
				...
				if (isset($this->_object['AddBillToTxn']))
				{
					$this->_object['AddBillToTxnAdd'] = $this->_object['AddBillToTxn'];
				}
	...
	public function asXML($root = null, $parent = null)
	{
		switch ($root)
		{
			case QUICKBOOKS_ADD_BILL:
				...
				if (!empty($this->_object['ApplyBillToTxnAdd']))
				{
					foreach ($this->_object['ApplyBillToTxnAdd'] as $key => $obj)
					{
						$obj->setOverride('ApplyBillToTxnAdd');
					}			
				}
