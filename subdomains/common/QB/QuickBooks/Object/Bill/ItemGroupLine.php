 ...
 * 
 */
class QuickBooks_Object_Bill_ItemGroupLine extends QuickBooks_Object
{
	/**
	 * Create a new QuickBooks_Object_Bill_ItemGroupLine object
	 * 
	 * @param array $arr
	 */
	...
	/**
	 * Set the ItemGroupRef ListID for the Bill
	 * 
	...
	/**
	 * Get the ItemGroupRef ListID for the Bill
	 * 
	 * @return string
	 */
	...
	/**
	 * Set the ItemGroupRef FullName for the Bill
	 * 
	...
	/**
	 * Get the ItemGroupRef FullName for the Bill
	 * 
	 * @return string
	 */
	...
	/**
	 * @see QuickBooks_Object_Bill_ItemGroupLineAdd::setDesc()
	 */
	...
	/**
	 * @see QuickBooks_Object_Bill_ItemGroupLineAdd::getDesc()
	 */
