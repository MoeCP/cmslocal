...
// This is create a check with hardcoded with values right now
function payrollCheck($API)
{	
	$qbxml = '<CheckAddRq><CheckAdd>

<AccountRef> 
	<FullName>Checking</FullName> <!-- must use this name -->
</AccountRef>

<PayeeEntityRef>
	<ListID >31</ListID> <!-- users QB ID number -->
	<FullName>Andrew Pineda</FullName>
</PayeeEntityRef>

<TxnDate >2010-07-01</TxnDate> <!-- use 15th June 2011 - 2 check --> 
<Memo>June 2011 - 1</Memo> <!-- if above June 2011 - 2--> 

<ExpenseLineAdd>
	<AccountRef>
		<ListID>69</ListID> <!-- must use this ID number -->
		<FullName>Contractor Payroll</FullName> <!-- must use this name -->
	</AccountRef>
	<Amount>1.00</Amount> <!-- amount of invoice -->
</ExpenseLineAdd>
...
// This is create a vendor with hardcoded with values right now, pass in variables 
function createVendor($API)
{	
	$qbxml = '<VendorAddRq><VendorAdd>
<Name >Linh Pham</Name> <!-- required -->
...
<City >Neverland</City> 
<State >CA</State> 
<PostalCode >90706</PostalCode> 
<Country >USA</Country> 
</VendorAddress>

<Phone>Direct Deposit</Phone> <!-- use Direct Deposit, Check or Paypal -->
<Mobile>321-131-5323</Mobile> <-- Users Main phone number -->
<Pager>123456789</Pager> <!-- Users Bank Routing Number -->
<AltPhone >1234098766</AltPhone> <!-- Users Bank Account Number -->
<Fax >22</Fax> <!-- must always be set to 22 -->
<Email >myEmail@gmail.com</Email>

<TermsRef>
<FullName >Due on the 15th</FullName>
</TermsRef>

<VendorTaxIdent>123-12-3123</VendorTaxIdent>
<IsVendorEligibleFor1099 >true</IsVendorEligibleFor1099>

</VendorAdd></VendorAddRq>';
	
	$API->qbxml($qbxml, '_get_vendor_callback');
}
