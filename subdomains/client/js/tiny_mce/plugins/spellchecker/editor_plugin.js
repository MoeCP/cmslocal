...
(function() {
	...
	tinymce.create('tinymce.plugins.SpellcheckerPlugin', {
		...
		init : function(ed, url) {
			...
			t.url = url;
			t.editor = ed;
			t.rpcUrl = ed.getParam("spellchecker_rpc_url", t.url+'/rpc.php');
		...
		_showMenu : function(ed, e) {
			...
			if (dom.hasClass(wordSpan, 'mceItemHiddenSpellWord')) {
				...
				t._sendRPC('getSuggestions', [t.selectedLang, dom.decode(wordSpan.innerHTML)], function(r) {
					...
					m.add({
						title : 'spellchecker.add_to_dictionary',
						onclick : function() {
                            t._sendRPC('addWordToPersonalDict', [t.selectedLang, dom.decode(e.target.innerHTML)], function(r){
                              if (r) {
                                alert('The word has been successfully added to the dictionary');
                              } else {
                                alert('Add word to dictionary failure');
                              }
                            });
