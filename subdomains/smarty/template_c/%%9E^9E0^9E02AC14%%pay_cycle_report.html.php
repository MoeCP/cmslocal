<?php /* Smarty version 2.6.11, created on 2014-11-14 10:43:20
         compiled from client_campaign/pay_cycle_report.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'client_campaign/pay_cycle_report.html', 20, false),array('function', 'eval', 'client_campaign/pay_cycle_report.html', 60, false),)), $this); ?>
...
<table id="table-1" cellspacing="0" align="center" cellpadding="0" class="sortableTable">
  ...
  <tr class="sortableTab">
    ...
    <th nowrap class="columnHeadInactiveBlack table-left-2" rowspan="2">#</th>
    <th nowrap class="columnHeadInactiveBlack" rowspan="2">Campaign Name</th>
    <th nowrap class="columnHeadInactiveBlack" rowspan="2">Client Name</th>
    <?php if ($this->_tpl_vars['user_permission_int'] == 5): ?>
    <th nowrap class="columnHeadInactiveBlack" rowspan="2">Total # Of Articles</th>
    <th nowrap class="columnHeadInactiveBlack" rowspan="2">Total # of Articles Editor approved</th>
    <th nowrap class="columnHeadInactiveBlack" rowspan="2">Total # of Client Approved</th>
    <?php else: ?>
    <th nowrap class="columnHeadInactiveBlack" rowspan="2">Approved Words</th>
    <th nowrap class="columnHeadInactiveBlack" rowspan="2">Approved Articles</th>
    <?php endif; ?>
    <th nowrap class="columnHeadInactiveBlack table-right-2" rowspan="2">Amount Owed</th>
...
" target="_blank" ><?php echo $this->_tpl_vars['item']['campaign_name']; ?>
    ...
    <?php if ($this->_tpl_vars['user_permission_int'] == 5): ?>
    <td><?php echo $this->_tpl_vars['item']['nofarticles']; ?>
</td>
    <td><?php echo $this->_tpl_vars['item']['nofeditorappr']; ?>
</td>
