<?php /* Smarty version 2.6.11, created on 2012-04-09 15:48:36
         compiled from article/edit_request_report.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'article/edit_request_report.html', 19, false),array('function', 'eval', 'article/edit_request_report.html', 61, false),array('modifier', 'truncate', 'article/edit_request_report.html', 74, false),array('modifier', 'date_format', 'article/edit_request_report.html', 78, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['item']['keyword']; ?>
    ...
    <td><?php echo $this->_tpl_vars['item']['rejected']; ?>
</td>
    <td>
    ...
    <td><?php if ($this->_tpl_vars['user_permission_int'] >= 3): ?><a href="<?php if ($this->_tpl_vars['user_permission_int'] == 3): ?>/article/article_list.php?campaign_id=<?php echo $this->_tpl_vars['item']['campaign_id'];  else: ?>/client_campaign/keyword_list.php?campaign_id=<?php echo $this->_tpl_vars['item']['campaign_id'];  endif; ?>" ><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['campaign_name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 20, "...") : smarty_modifier_truncate($_tmp, 20, "...")); ?>
</a><?php else:  echo $this->_tpl_vars['item']['campaign_name'];  endif; ?></td>
...
', 'height=300,width=200,status=no,toolbar=no,menubar=no,location=no,resizable=yes,scrollbars=yes');"><?php echo $this->_tpl_vars['item']['ue_name']; ?>
    ...
    <td align="left" nowrap class="table-right-2">
	      <input type="button" class="button" value="Edit" onclick="javasript:window.location='/article/approve_article.php?article_id=<?php echo $this->_tpl_vars['item']['article_id']; ?>
&keyword_id=<?php echo $this->_tpl_vars['item']['keyword_id']; ?>
&fmp=edit_request';" />
    </td>
