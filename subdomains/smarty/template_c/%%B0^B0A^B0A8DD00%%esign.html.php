<?php /* Smarty version 2.6.11, created on 2012-05-24 12:38:34
         compiled from user/esign.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'user/esign.html', 70, false),)), $this); ?>
...
<div id="page-box1">
  <h2>Send EchoSign Documents to "<?php echo $this->_tpl_vars['user']['first_name']; ?>
...
" />
  <input type="hidden" name="title" value="<?php echo $this->_tpl_vars['config']['gtitle']; ?>
" />
  <tr>
  ...
  <tr><td></td><td class="requiredInput" style="text-align:left" >Send E-Sign Documents to "<?php echo $this->_tpl_vars['user']['first_name']; ?>
 <?php echo $this->_tpl_vars['user']['last_name']; ?>
"</td></tr>
  <tr>
    <td class="requiredInput">Message</td>
    <td><textarea name="message"  cols="60" rows="7" id="message"><?php echo $this->_tpl_vars['template_info']['body']; ?>
</textarea></td>
  </tr>
  <tr>
...
%%||||%%<?php echo $this->_tpl_vars['item']['documentKey']; ?>
" name="reusable[]" id="<?php echo $this->_tpl_vars['item']['documentKey']; ?>
