<?php /* Smarty version 2.6.11, created on 2013-03-01 14:42:45
         compiled from client_campaign/image_keyword_list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'client_campaign/image_keyword_list.html', 57, false),array('function', 'eval', 'client_campaign/image_keyword_list.html', 158, false),array('modifier', 'nl2br', 'client_campaign/image_keyword_list.html', 166, false),array('modifier', 'strip', 'client_campaign/image_keyword_list.html', 166, false),array('modifier', 'escape', 'client_campaign/image_keyword_list.html', 166, false),array('modifier', 'truncate', 'client_campaign/image_keyword_list.html', 173, false),array('modifier', 'date_format', 'client_campaign/image_keyword_list.html', 177, false),)), $this); ?>
...
<div id="page-box1">
  ...
  <ul id="campaign-nav">
    <?php if (( $this->_tpl_vars['login_permission'] > 3 || $this->_tpl_vars['login_permission'] == 2 ) && $this->_tpl_vars['campaign_id'] > 0): ?>        <li><a href="/client_campaign/image_keyword_add.php?campaign_id=<?php echo $this->_tpl_vars['campaign_id']; ?>
"><img alt="Add Keyword" src="/images/button-add-keyword.gif" /></a></li>
        <li><a href="/graphics/batch_assign_keyword.php?campaign_id=<?php echo $this->_tpl_vars['campaign_id']; ?>
" ><img alt="Batch Assignment" src="/images/button-batch-assignment.gif" /></a></li><?php endif; ?>
    <?php if (( $this->_tpl_vars['login_role'] == 'admin' || $this->_tpl_vars['login_role'] == 'client' ) && $this->_tpl_vars['campaign_id'] != ''): ?>
        <li><a href="/graphics/download_image_list.php?campaign_id=<?php echo $this->_tpl_vars['campaign_id']; ?>
...
', 'D', 'This Client Campaign')" ><img alt="Delete" src="/images/button-delete.gif" /></a></li>
      <?php endif; ?>
      <?php if ($this->_tpl_vars['login_permission'] >= 4): ?>
      <li><a href="/graphics/acceptance.php?campaign_id=<?php echo $this->_tpl_vars['campaign_id']; ?>
...
"/>
      ...
      <td nowrap>Status</td>
      <td colspan="2" nowrap>
        <select name="image_status" id="image_status" ><option value="">[show all]</option><?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['image_status'],'selected' => $_GET['image_status']), $this);?>
</select>&nbsp;&nbsp;&nbsp;
      </td>
      <td rowspan="2" >
...
<?php if ($this->_tpl_vars['is_pay_adjust'] != 1 && $this->_tpl_vars['total']): ?>
    <?php if ($this->_tpl_vars['show_cb'] == true || ( $this->_tpl_vars['is_forceclientapprove'] == 1 && $_GET['image_status'] == '4' ) || ( $this->_tpl_vars['is_googlecheck'] == 1 && $this->_tpl_vars['login_role'] != 'client' && $this->_tpl_vars['login_role'] != 'copywriter' && $_GET['image_status'] == '1' )): ?>
...
" />
    ...
    <td>
            <?php if ($this->_tpl_vars['login_permission'] == 2 || $this->_tpl_vars['login_permission'] == 4 && ( $this->_tpl_vars['item']['image_status'] <= '1' || $this->_tpl_vars['item']['image_status'] == '1gd' )): ?>
	<?php echo $this->_tpl_vars['item']['keyword']; ?>

    <?php else: ?>
	<a href="/graphics/approve_image.php?image_id=<?php echo $this->_tpl_vars['item']['image_id']; ?>
...
" onMouseOver="return overlib('<table width=500><tr><td nowrap>Keyword Instructions</td><td ><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['keyword_description'])) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)))) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
    ...
    <td>
    <?php echo $this->_tpl_vars['image_status'][$this->_tpl_vars['item']['image_status']]; ?>
...
', 'height=300,width=400,status=no,toolbar=no,menubar=no,location=no,resizable=yes,scrollbars=yes');"><?php echo $this->_tpl_vars['item']['ue_name']; ?>
    ...
    <td><?php if ($this->_tpl_vars['item']['image_status'] == '0' || $this->_tpl_vars['item']['image_status'] == ''): ?>n/a<?php else:  echo ((is_array($_tmp=$this->_tpl_vars['item']['cp_updated'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%m-%d-%Y") : smarty_modifier_date_format($_tmp, "%m-%d-%Y"));  endif; ?></td>
    <td><?php if ($this->_tpl_vars['item']['approval_date'] > 0 && ( $this->_tpl_vars['item']['image_status'] == '3' || $this->_tpl_vars['item']['image_status'] == '4' || $this->_tpl_vars['item']['image_status'] == '5' || $this->_tpl_vars['item']['image_status'] == '6' )):  echo $this->_tpl_vars['item']['approval_date'];  endif; ?></td>
    <td><?php if ($this->_tpl_vars['item']['client_approval_date'] > 0 && ( $this->_tpl_vars['item']['image_status'] == '5' || $this->_tpl_vars['item']['image_status'] == '6' )):  echo $this->_tpl_vars['item']['client_approval_date'];  endif; ?></td>
    <td><?php echo $this->_tpl_vars['image_type'][$this->_tpl_vars['item']['image_type']]; ?>
</td>
    <td align="left" nowrap class="table-right-2">
    <?php if ($this->_tpl_vars['login_permission'] > 3): ?>    <?php if ($this->_tpl_vars['login_role'] != 'copy writer' && $this->_tpl_vars['item']['image_id'] > 0): ?>
    <?php if ($this->_tpl_vars['login_permission'] == 4 && ( $this->_tpl_vars['item']['image_status'] <= '1' )): ?>
    <?php else: ?>
    <input type="button" class="button" value="Preview" onclick="openLink('/graphics/image_comment_list.php?image_id=<?php echo $this->_tpl_vars['item']['image_id']; ?>
');" />
    <?php endif; ?>
    <?php else: ?>
    <input type="button" class="button" value="Comment" onclick="openLink('/graphics/image_comment_list.php?image_id=<?php echo $this->_tpl_vars['item']['image_id']; ?>
');" />
    <?php endif; ?>
		    <?php if ($this->_tpl_vars['item']['image_status'] == '5'): ?>
		<input type="submit" class="button" value="Publish" onclick="return doSubmit('campaign_keyword_list', 'image_id', '<?php echo $this->_tpl_vars['item']['image_id']; ?>
', 'P')" />
    <?php endif; ?>
    <?php elseif ($this->_tpl_vars['login_permission'] == 2): ?>
      <input type="button" class="button" value="Preview" onclick="window.open('/graphics/image_comment_list.php?image_id=<?php echo $this->_tpl_vars['item']['image_id']; ?>
');" />
    <?php endif; ?>
     </td>
