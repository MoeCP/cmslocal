<?php /* Smarty version 2.6.11, created on 2012-03-14 15:33:30
         compiled from client/ajax_client_form.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'client/ajax_client_form.html', 98, false),array('function', 'html_options', 'client/ajax_client_form.html', 139, false),)), $this); ?>
...
<div id="page-box1">
  ...
  <div class="form-item" >
<form action="/client/ajax_client_set.php" method="post"  name="f_client" <?php if ($this->_tpl_vars['js_check'] == true): ?> onsubmit="return check_f_client()"<?php endif; ?>>
...
">
  <?php if ($this->_tpl_vars['user_permission_int'] == 2 && $this->_tpl_vars['client_info']['client_id'] > 0): ?>
...
">
  <?php endif; ?>
  <?php if ($this->_tpl_vars['login_role'] == 'client'): ?><input type="hidden" name="project_manager_id" value="<?php echo $this->_tpl_vars['client_info']['project_manager_id']; ?>
" /><?php endif; ?>
  <tr>
  ...
  <tr>
    ...
    <input name="user_name" type="text" id="user_name" value="<?php echo $this->_tpl_vars['client_info']['user_name']; ?>
" onchange="javascript:this.value=Trim(this.value)" />
    <?php else: ?>
    <?php echo $this->_tpl_vars['client_info']['user_name']; ?>

    <input name="user_name" type="hidden" id="user_name" value="<?php echo $this->_tpl_vars['client_info']['user_name']; ?>
" onchange="javascript:this.value=Trim(this.value)" />
    <?php endif; ?>
    </td>
  </tr>
...
" onchange="javascript:this.value=Trim(this.value)"></td>
  ...
  <tr>
    ...
    <td><textarea name="company_address" cols="25" rows="4" id="company_address"><?php echo $this->_tpl_vars['client_info']['company_address']; ?>
</textarea></td>
  </tr>
  <tr>
...
" onchange="javascript:this.value=Trim(this.value)"></td>
  ...
  <?php if ($this->_tpl_vars['login_role'] != 'client' && ( $this->_tpl_vars['user_permission_int'] >= 5 || $this->_tpl_vars['user_permission_int'] == 2 )): ?>
  <tr>
    ...
    <?php else: ?>
       <?php echo $this->_tpl_vars['all_pm'][$this->_tpl_vars['client_info']['project_manager_id']]; ?>

       <input type="hidden" value="<?php echo $this->_tpl_vars['client_info']['project_manager_id']; ?>
