<?php /* Smarty version 2.6.11, created on 2012-05-21 05:43:03
         compiled from client_campaign/update_keyword_instructions.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'client_campaign/update_keyword_instructions.html', 19, false),array('modifier', 'escape', 'client_campaign/update_keyword_instructions.html', 84, false),array('modifier', 'nl2br', 'client_campaign/update_keyword_instructions.html', 88, false),array('modifier', 'strip', 'client_campaign/update_keyword_instructions.html', 88, false),array('modifier', 'truncate', 'client_campaign/update_keyword_instructions.html', 93, false),array('modifier', 'date_format', 'client_campaign/update_keyword_instructions.html', 96, false),)), $this); ?>
...
" name="campaign_keyword_list" method="post" onsubmit="return batchKeywordInstructions()" />
<input name="campaign_id" type="hidden" value="<?php echo $this->_tpl_vars['campaign_id']; ?>
" />
...
"  />
        <input type="hidden" name="keyword_desc[<?php echo $this->_foreach['loop_all']['iteration']; ?>
]" id="keyword_desc_<?php echo $this->_foreach['loop_all']['iteration']; ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['keyword_description'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" />
      </td>
