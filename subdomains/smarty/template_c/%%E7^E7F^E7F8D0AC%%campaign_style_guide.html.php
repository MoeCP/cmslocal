<?php /* Smarty version 2.6.11, created on 2014-08-14 10:26:37
         compiled from client_campaign/campaign_style_guide.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'client_campaign/campaign_style_guide.html', 48, false),array('modifier', 'html_entity_decode', 'client_campaign/campaign_style_guide.html', 57, false),)), $this); ?>
...
<div id="page-box1">
  <h2><?php if ($_GET['qtype'] == 'editor_grading_rubric'): ?>Editor Grading Rubric Information<?php else: ?>Content Production Style Guide Information<?php endif; ?></h2>
  <div class="view-item" >
...
<?php if ($_GET['qtype'] == 'editor_grading_rubric'): ?>
  <tr>
    <td colspan="4">
      <div nowrap="nowrap" class="requiredInput2"><a href="javascript:void(0)" onclick="openWindow('/manual_content/tip.php?ukey=EDITOR_GRADING_RUBRIC','height=370,width=450,status=no,toolbar=no,menubar=no,location=no,resizable=no,scrollbars=no')" class="classtips">Editor Grading Rubric</a></div>
      <div <?php if ($this->_tpl_vars['info']['style_id'] > 0): ?>class="divContent"<?php else: ?>class="divContent2"<?php endif; ?>>
	  <?php if ($this->_tpl_vars['info']['editor_grading_rubric'] != ''): ?>
	  <?php echo ((is_array($_tmp=$this->_tpl_vars['info']['editor_grading_rubric'])) ? $this->_run_mod_handler('html_entity_decode', true, $_tmp) : html_entity_decode($_tmp)); ?>

	  <?php else: ?>No rubric provided.<br />
	  <?php endif; ?>
	  </div></td>
  </tr>
<?php else: ?>
