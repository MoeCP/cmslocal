<?php /* Smarty version 2.6.11, created on 2012-03-22 21:31:40
         compiled from client_campaign/payment_log.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'client_campaign/payment_log.html', 42, false),array('modifier', 'date_format', 'client_campaign/payment_log.html', 45, false),)), $this); ?>
...
<table border="0" cellspacing="1" cellpadding="4">
  <tr><td class="moduleTitle" ><?php if ($this->_tpl_vars['role'] == 'editor'): ?>Editor<?php else: ?>Copywriter<?php endif; ?> Payment Log</td></tr>
</table>
...
?>
  <tr class="<?php if ($this->_foreach['loop']['iteration'] % 2 == 0): ?>even<?php else: ?>odd<?php endif; ?>">
    ...
    <td><?php echo $this->_tpl_vars['item']['cp_name']; ?>
</td>
