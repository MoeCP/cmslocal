<?php /* Smarty version 2.6.11, created on 2012-03-16 10:50:26
         compiled from user/payment.html */ ?>
...
<table id="table-1" cellspacing="0" cellpadding="0" align="center" class="sortableTable">
  ...
  <tr class="sortableTab">
    ...
    <td nowrap class="columnHeadInactiveBlack table-left-2">Copywriter</td>
    <td nowrap class="columnHeadInactiveBlack">Campaign Name</td>
    <td nowrap class="columnHeadInactiveBlack">Month</td>
    <td nowrap class="columnHeadInactiveBlack">Pay Date</td>
    <td nowrap class="columnHeadInactiveBlack table-right-2">Payment</td>
...
var st = new SortableTable(document.getElementById("table-1"),
  ["None", "CaseInsensitiveString", "CaseInsensitiveString",   "Number", "Date",  "Number"]);
