<?php /* Smarty version 2.6.11, created on 2012-03-05 13:35:34
         compiled from client_campaign/view_invoice.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'client_campaign/view_invoice.html', 10, false),array('modifier', 'date_format', 'client_campaign/view_invoice.html', 10, false),array('modifier', 'regex_replace', 'client_campaign/view_invoice.html', 37, false),array('modifier', 'truncate', 'client_campaign/view_invoice.html', 98, false),array('function', 'eval', 'client_campaign/view_invoice.html', 43, false),)), $this); ?>
...
<table cellspacing="0" cellpadding="4" align="center" class="even" width="99%">
 ...
 <?php echo $this->_tpl_vars['user_info']['last_name']; ?>
    ...
    <td>
     <input name="date_pay" type="text" id="date_pay" readonly value="<?php if ($this->_tpl_vars['cp_payment_info']['date_pay'] != '0000-00-00 00:00:00' && $this->_tpl_vars['cp_payment_info']['date_pay'] != ''):  echo $this->_tpl_vars['cp_payment_info']['date_pay'];  else:  echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d %H:%M:%S") : smarty_modifier_date_format($_tmp, "%Y-%m-%d %H:%M:%S"));  endif; ?>" />
     </td>
    </tr>
    <tr>
    <td class="requiredInput">Invoice Number:</td><td><input type="text" readonly name="invoice_no"  value="<?php echo $this->_tpl_vars['cp_payment_info']['user_id']; ?>
-<?php echo $this->_tpl_vars['cp_payment_info']['month']; ?>
" readonly /></td>
    <td class="requiredInput">Check/Billing Pay No.:</td><td><input type="text" readonly name="check_no"  value="<?php echo $this->_tpl_vars['cp_payment_info']['check_no']; ?>
" /></td>
    <td class="requiredInput">Amount Paid:</td><td><input type="text" readonly name="payment"  value="<?php if ($this->_tpl_vars['cp_payment_info']['payment'] > 0):  echo $this->_tpl_vars['cp_payment_info']['payment'];  elseif ($this->_tpl_vars['report']['all']['cost'] > 0):  echo $this->_tpl_vars['report']['all']['cost'];  endif; ?>" <?php if ($this->_tpl_vars['cp_payment_info']['invoice_status'] == 1): ?>readonly<?php endif; ?>/></td>
    </tr>
    <tr>
        <td class="requiredInput">Notes:</td>
        <td colspan="10"><textarea name="notes" id="notes" rows="5" cols="100" readonly ><?php echo $this->_tpl_vars['cp_payment_info']['notes']; ?>
</textarea></td>
    </tr>
     <tr>
    </tr>
...
?>
 ...
 Article Cost per Word:
    </td>
    <td>
        $<?php echo $this->_tpl_vars['item']['cost_per_article']; ?>
...
" target="_blank"><?php echo $this->_tpl_vars['item']['article_number']; ?>
    ...
    <td class="table-right-2"><?php echo $this->_tpl_vars['item']['cost_for_article']; ?>
</td>
