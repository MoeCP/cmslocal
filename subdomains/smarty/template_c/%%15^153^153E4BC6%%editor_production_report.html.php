<?php /* Smarty version 2.6.11, created on 2012-04-10 06:02:44
         compiled from client_campaign/editor_production_report.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'client_campaign/editor_production_report.html', 52, false),array('function', 'eval', 'client_campaign/editor_production_report.html', 89, false),array('modifier', 'date_format', 'client_campaign/editor_production_report.html', 101, false),)), $this); ?>
...
<form action="/client_campaign/editor_production_report.php" name="users_list" id="users_list<?php echo $this->_tpl_vars['item']['user_id']; ?>
" method="post" >
...
<table id="table-1" cellspacing="0" align="center" cellpadding="0" class="sortableTable">
  ...
  <tr class="sortableTab">
    ...
    <td nowrap class="columnHeadInactiveBlack">% Pending Approaval</td>
...
&role=<?php echo $this->_tpl_vars['item']['role'];  echo $this->_tpl_vars['query_string']; ?>
', 'report_result');return false;" >View Campaigns</a><?php endif; ?></td>
    <td><?php if ($this->_tpl_vars['item']['total'] > 0): ?><a href="/article/articles.php?editor_id=<?php echo $this->_tpl_vars['item']['user_id']; ?>
