<?php /* Smarty version 2.6.11, created on 2012-09-19 14:10:26
         compiled from client_campaign/fadd_keyword.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'client_campaign/fadd_keyword.html', 168, false),)), $this); ?>
...
" /><?php endif; ?>
  ...
  <tr>
    ...
    <td><textarea name="keyword" cols="35" rows="7" id="keyword" onblur="cmsCalcLine(this.value,'keyword')"><?php echo $this->_tpl_vars['keyword_info']['keyword']; ?>
</textarea><div id="keyword_lines"></div></td>
    <td class="dataLabel">Mapping-ID</td>
    <td><textarea name="mapping_id" cols="35" rows="7" id="mapping_id" onblur="cmsCalcLine(this.value,'mapping_id')"><?php echo $this->_tpl_vars['keyword_info']['mapping_id']; ?>
</textarea><div id="mapping_id_lines"></div></td>
  </tr>
...
</textarea><div id="<?php echo $this->_tpl_vars['key']; ?>
_lines"></div></td>
...
" readonly/>
  ...
  <tr>
    ...
    <td colspan="3"><textarea name="keyword_description" cols="35" rows="4" id="keyword_description"><?php echo $this->_tpl_vars['keyword_info']['keyword_description']; ?>
</textarea></td>
  </tr>
  ...
  <td><select name="article_type"><?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['article_type'],'selected' => $this->_tpl_vars['keyword_info']['article_type']), $this);?>
</select></td>
  </tr>
  <?php else: ?>
  <input type="hidden" name="article_type" value="<?php echo $this->_tpl_vars['keyword_info']['article_type']; ?>
" />
  <?php endif; ?>
  <tr>
