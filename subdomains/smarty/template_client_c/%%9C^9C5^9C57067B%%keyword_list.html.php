<?php /* Smarty version 2.6.11, created on 2015-02-18 13:34:37
         compiled from client_campaign/keyword_list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'client_campaign/keyword_list.html', 67, false),array('function', 'eval', 'client_campaign/keyword_list.html', 180, false),array('modifier', 'nl2br', 'client_campaign/keyword_list.html', 188, false),array('modifier', 'strip', 'client_campaign/keyword_list.html', 188, false),array('modifier', 'escape', 'client_campaign/keyword_list.html', 188, false),array('modifier', 'truncate', 'client_campaign/keyword_list.html', 204, false),array('modifier', 'date_format', 'client_campaign/keyword_list.html', 209, false),)), $this); ?>
...
', 'height=300,width=400,status=no,toolbar=no,menubar=no,location=no,resizable=yes,scrollbars=yes');"><?php echo $this->_tpl_vars['item']['uc_name']; ?>
    ...
    <td><?php if ($this->_tpl_vars['item']['qaer_id'] > 0):  if ($this->_tpl_vars['login_role'] == 'agency' || $this->_tpl_vars['login_permission'] == 4):  echo $this->_tpl_vars['item']['uq_name'];  else: ?><a href="javascript:void(0)" onclick="openWindow('/user/user_detail_info.php?user_id=<?php echo $this->_tpl_vars['item']['qaer_id']; ?>
