...
class Email {
        ...
        */
        ...
        $q = "INSERT INTO email_templates (template_id, event_id, foldername, templatename, subject, `description`, body, deleted) ".
             "VALUES ('".$template_id."', ".
                     "'".$event_id."', ".
                     "'".$foldername."', ".
                     "'".addslashes($g_tag['email_event'][$event_id])."', ".
                     "'".$subject."', ".
                     "'".$description."', ".
                     "'".$body."', ".
                     "'0')";
        ...
        */
        ...
        $conn->Execute("UPDATE email_templates ".
                       "SET foldername = '".$foldername."', ".
                           "event_id = '".$event_id."', ".
                           "templatename = '".addslashes(htmlspecialchars(trim($g_tag['email_event'][$event_id])))."', ".
                           "subject = '".$subject."', ".
    ...
    function sendAnnouceMail($event_id, $to, $p = array(), $subject =null, $cc=array(), $bcc=array())
    {
        ...
        if (is_array($to)) {
            ...
            return send_smtp_mail($to, $subject, $body, $mailer_param);
        }
        return true;
    }
