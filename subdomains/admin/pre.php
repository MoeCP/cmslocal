...
$w9_dir =  $g_article_storage . 'w9' . DS;
define('CAMPAIGN_KEYWORD_FILE_PATH', $g_article_storage . 'campaign_keywords' . DS);
...
$smarty->compile_dir  = CMS_SMARTY_ROOT.'/template_c/';
