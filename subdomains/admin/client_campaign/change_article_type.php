...
if( !empty( $_POST ) )
{
    Campaign::updateArticleTypeByParam($_POST);
    echo "<script>alert('" . $feedback . "');</script>";
    $query_string = $_SERVER['QUERY_STRING'];
    echo "<script>window.location.href='/client_campaign/change_article_type.php" . (empty($query_string) ? '' : '?' . $query_string) .  "';</script>";
    exit;
}
...
$smarty->display('client_campaign/change_article_type.html');
?>