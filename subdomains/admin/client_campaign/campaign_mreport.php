...
if (!empty($_GET)) {
    ...
    if ($opt_action == 'export') {
        ...
        $result = ArticlePaymentLog::monthlyReport('campaign', $_GET, false);
...
$search = ArticlePaymentLog::monthlyReport('campaign', $_GET);
if ($search) {
...
$smarty->display('client_campaign/campaign_mreport.html');
?>