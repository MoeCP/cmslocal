...
$search = UserMonthPerformance::getPerformanceReport($param);
if (!empty($search)) {
...
//echo "<pre>";
//print_r ($all_cp);
$monthes = UserMonthPerformance::getAllMonthes();
...
$smarty->display('client_campaign/cp_month_performance_report.html');
?>