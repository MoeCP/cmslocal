...
$search = ArticlePaymentLog::getClientApprovalList($p);
if ($search) {
...
$month = $p['month'];
if( $month== 0 || $month=='' ) $month = changeTimeToPayMonthFormat(time());
...
$smarty->display('client_campaign/completed_keywords.html');
?>