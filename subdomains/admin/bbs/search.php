...
//
$userdata = session_pagestart($phpbb_user_ip, PAGE_SEARCH);
...
else if ( $search_keywords != '' || $search_author != '' || $search_id )
{
	...
	if ( $search_id == 'newposts' || $search_id == 'egosearch' || $search_id == 'unanswered' || $search_keywords != '' || $search_author != '' )
	{
		...
		// Flood control
		//
		$where_sql = ($userdata['user_id'] == ANONYMOUS) ? "se.session_ip = '$phpbb_user_ip'" : 'se.session_user_id = ' . $userdata['user_id'];
