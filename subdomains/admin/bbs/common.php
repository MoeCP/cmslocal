...
$phpbb_user_ip = encode_ip($client_ip);
...
$baseDir = preg_replace('/[\/\\\]bbs[\/\\\\s\S]*$/', '', $baseDir);
$baseUrl = preg_replace('/[\/\\\]bbs[\/\\\\s\S]*$/', '', $baseUrl);

$forumDir = $baseDir . '/bbs';
$forumUrl = $baseUrl . '/bbs';
include_once($forumDir . '/mandel_hack/start.' . $phpEx);
//<------------------Mandel Hack End------------------------->*/
