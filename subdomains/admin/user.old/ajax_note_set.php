...
$users = User::getAllUsers($mode = 'id_name_only', $user_type = 'editor', false);
$users += User::getAllUsers($mode = 'id_name_only', $user_type = 'copy writer', false);
$note_id = isset($_GET['note_id'])&&!empty($_GET['note_id']) ? $_GET['note_id'] : '';
$note = UserNote::getInfo($note_id);
if (!empty($note)) {
