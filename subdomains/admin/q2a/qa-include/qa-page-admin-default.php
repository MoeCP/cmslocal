		...
		if (empty($optionname)) {
			...
			switch ($optionname) { // special treatment for certain options
				...
				case 'permit_anon_view_ips':
					...
					elseif ( ($optionname=='permit_edit_c') || ($optionname=='permit_close_q') || ($optionname=='permit_select_a') || ($optionname=='permit_moderate')|| ($optionname=='permit_hide_show') || ($optionname=='permit_anon_view_ips') || ($optionname=='permit_post_q'))
