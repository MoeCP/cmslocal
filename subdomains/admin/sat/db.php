<?php
	...
	define("EZSQL_DB_USER", "cmsdemo"); //		cmsdemo	// <-- mysql db user
	define("EZSQL_DB_PASSWORD", "cms8704");//		cms8704// <-- mysql db password
	define("EZSQL_DB_NAME", "ws_com_cpcmsdemo_www");		// <-- mysql db pname
...
$dgdb = new db(EZSQL_DB_USER, EZSQL_DB_PASSWORD, EZSQL_DB_NAME, EZSQL_DB_HOST);
$dgdb->query("SET NAMES 'utf8'");
