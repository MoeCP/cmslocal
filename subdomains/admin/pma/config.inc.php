...
//$cfg['Servers'][$i]['user']          = 'webusdderddddd';      // MySQL user
//$cfg['Servers'][$i]['password']      = 'i9^ddd8uttddddd';          // MySQL password (only needed
                                                    // with 'config' auth_type)
//$cfg['Servers'][$i]['only_db']       = 'com_i9cms_ewiki';          // If set to a db-name, only
...
$cfg['Servers'][$i]['user']            = 'cmsdemo';
$cfg['Servers'][$i]['password']        = 'cms8704';
$cfg['Servers'][$i]['only_db']         = 'ws_com_cpcmsdemo_www';
...
$cfg['ThemePath']           = './themes';    // using themes manager please set up here the path to 'themes'
                                             // else leave empty
$cfg['ThemeManager']        = FALSE;          // if you want to use selectable themes and if ThemesPath not empty
