<?php
/* $Id: index.php,v 2.12 2004/08/26 11:11:12 lem9 Exp $ */
...
// added by snug xu 2007-09-17 15:54 - STARTED
if ($PHP_AUTH_USER == 'root')
{
    //die("You have no privilege!");
    $url = $cfg['PmaAbsoluteUri'] . "index.php?" . PMA_generate_common_url() . "&amp;old_usr=" . urlencode($PHP_AUTH_USER);
    $cfg['Server'] = array();
    // echo($url);
    echo "<script>";
...
// added by snug xu 2007-09-17 15:54 - FINISHED
/**
