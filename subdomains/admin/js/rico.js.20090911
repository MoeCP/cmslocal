...
Rico.Corner = {
   ...
   round: function(e, width, options) {
      var e = $(e);
      ...
      this._roundCornersImpl(e, width, color, bgColor);
   },

   _roundCornersImpl: function(e, width, color, bgColor) {
      if(this.options.border)
         this._renderBorder(e,bgColor);
      if(this._isTopRounded())
         this._roundTopCorners(e,width, color,bgColor);
      if(this._isBottomRounded())
         this._roundBottomCorners(e, width,  color,bgColor);
   },
   ...
   _roundTopCorners: function(el, width, color, bgColor) {
      var corner = this._createCorner(width,	bgColor);
   ...
   _roundBottomCorners: function(el, width, color, bgColor) {
      var corner = this._createCorner(width, bgColor);
   ...
   _createCorner: function(width, bgColor) {
      var corner = document.createElement("div");
      corner.style.backgroundColor = (this._isTransparent() ? "transparent" : bgColor);
	  corner.style.width = width;
      return corner;
   },
