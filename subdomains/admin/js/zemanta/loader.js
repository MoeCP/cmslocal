(function () {
	...
	widget.innerHTML = '<div id="zemanta-control" class="zemanta"></div><div id="zemanta-message" class="zemanta">Loading Zemanta...</div><div id="zemanta-filter" class="zemanta"></div><div id="zemanta-gallery" class="zemanta"></div></div>';
	
	(function () {
		var insertionSpace = document.getElementById('put-zemanta-before-this-element');
		if (insertionSpace) {
