 ...
 */
    ...
    //$personal_dict_path = 'F:/Htdocs/leotest/logs/personal_dictionary.pws';
	...
	if (count($tinyspell->errorMsg) == 0) {
		switch($cmd) {
			...
			// added by leo.liuxl@gmail.com
			case "addtodict":
				//$result = $tinyspell->addWordToPersonalDict($wrod);
				if ($tinyspell->addWordToPersonalDict($check)) {
					$outputType = $outputType . "Save successful!";
				} else {
					$outputType = $outputType . "Save Failed!";
				}
				$tinyspell->errorMsg[] ="dddd";
			break;
			//end added 2006-11-27
